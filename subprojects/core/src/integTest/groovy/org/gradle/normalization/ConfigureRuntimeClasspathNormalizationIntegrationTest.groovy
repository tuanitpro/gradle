    ...
    class ProjectWithRuntimeClasspathNormalization {
        ...
        ProjectWithRuntimeClasspathNormalization(String projectName = null, Api api) {
            ...
            nestedInDirJarContents = root.file('nestedInDirJarContents').create {
                ...
                propertiesFileInNestedInDirJar = new PropertiesResource(file('some/path/to/foo.properties'), [(IGNORE_ME_TOO): 'this should be ignored', (DONT_IGNORE_ME): 'this should not be ignored'], this.&createNestedInDirJar)
            }
            root.file('classpath/dirEntry').create {
                ...
                propertiesFileInDir = new PropertiesResource(file('some/path/to/foo.properties'), [(IGNORE_ME_TOO): 'this should be ignored', (DONT_IGNORE_ME): 'this should not be ignored'])
            }
            nestedJarContents = root.file('libraryContents').create {
                ...
                propertiesFileInNestedJar = new PropertiesResource(file('some/path/to/foo.properties'), [(IGNORE_ME_TOO): 'this should be ignored', (DONT_IGNORE_ME): 'this should not be ignored'], this.&createJar)
            }
            libraryJarContents = root.file('libraryContents').create {
                ...
                propertiesFileInJar = new PropertiesResource(file('some/path/to/foo.properties'), [(IGNORE_ME_TOO): 'this should be ignored', (DONT_IGNORE_ME): 'this should not be ignored'], this.&createJar)
            }
